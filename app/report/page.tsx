        ...
        <div className="max-w-md w-full">
          ...
          <Card className="p-8 shadow-xl border-0 bg-white/80 backdrop-blur-sm text-center">
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
              <h3 className="font-semibold text-green-800 mb-2">Your Secure Tracking ID</h3>
            ...
            <div className="space-y-4 text-sm text-slate-600 text-left">
              <div className="flex items-start gap-3">
                ...
                <span>Use this tracking ID to monitor your report's progress</span>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="mt-6 space-y-3">
              <Button 
                onClick={() => window.location.href = `/track?tid=${trackingId}`}
      ...
      <FormControl>
        <Input 
          ...
          className={`w-full p-4 border rounded-xl bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${
            fieldState?.error ? "border-red-300 ring-2 ring-red-100" : "border-slate-300"
          }`}
        />
      </FormControl>
      ...
      <div className="space-y-1">
        {Array.from(files).map((file, index) => (
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p className="mt-1">All information is encrypted and your identity remains anonymous. No personal data is stored.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            <h3 className="text-sm font-semibold text-slate-900 mb-3">Supported Evidence Formats</h3>
