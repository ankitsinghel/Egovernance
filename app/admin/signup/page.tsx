      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <Card className="p-12 text-center shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <p className="text-slate-600 mt-2">
            Verifying admin setup requirements...
          </p>
        </Card>
      </div>
    );
        ...
        <div className="max-w-md w-full">
          ...
          <Card className="p-8 shadow-xl border-0 bg-white/80 backdrop-blur-sm text-center">
            ...
            <p className="text-slate-600 mb-6">
              ...
              Please contact your SuperAdmin to create new accounts or use an
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      <User className="w-4 h-4 inline-block mr-2" /> Full Name
                    </FormLabel>
                    <FormControl>
                      <input
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      <Lock className="w-4 h-4 inline-block mr-2" /> Password
                    </FormLabel>
                    <FormControl>
                      <div className="relative">
                        <input
