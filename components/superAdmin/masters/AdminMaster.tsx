...
//         <h1 className="text-2xl font-bold">Central Admins</h1>
//         <div className="flex items-center gap-2">
//           <Button onClick={() => refreshAdmins()} disabled={loading}>
//             Refresh Admins
//           </Button>
//           <Button
//             onClick={() => {
...
//             ) : (
//               <tr>
//                 <td colSpan={5} className="p-4 text-center text-sm text-muted">
...
//             <h3 className="text-lg font-semibold mb-2">New Central Admin</h3>
...
//                     {...(createForm.register("departmentId") as any)}
//                   >
...
//                     <p className="text-xs text-red-600">
//                       {
//                         (createForm.formState.errors.departmentId as any)
//                           .message
//                       }
//                     </p>
//                   )}
...
//         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
//           <div className="bg-white p-6 rounded w-96">
//             <h3 className="text-lg font-semibold mb-2">Edit Admin</h3>
...
//                   <select
//                     className="w-full p-2 border rounded"
//                     {...(editForm.register("departmentId") as any)}
//                   >
//                     <option value={0}>Select Department</option>
//                     {departments.map((d: any) => (
//                       <option key={d.id} value={d.id}>
